---
description: 從專案上下文產生非功能需求文件（80_nfr.md），包含效能、可用性、可靠性、維運、擴展性、安全性與合規性需求。
---
...
- **10_business.md** 的業務目標 → **80_nfr.md** 的效能期望
- **20_process.md** 的流程步驟 → **80_nfr.md** 的回應時間需求
- **30_risk_control.md** 的 KRI → **80_nfr.md** 的監控指標
- **40_infosec.md** 的資安控制 → **80_nfr.md** 的安全性 NFR
- **60_law.md** 的法遵要求 → **80_nfr.md** 的合規性 NFR
- **60_audit.md** 的稽核需求 → **80_nfr.md** 的日誌效能需求
