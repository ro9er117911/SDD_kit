...
/**
 * Independent DOCX Generator
 * Generates Word document from Bank Profile files
 */
...
async function main() {
    console.log('═══════════════════════════════════════');
    console.log('   Bank Profile DOCX Generator');
    console.log('═══════════════════════════════════════\n');
    ...
    try {
        ...
        // Generate DOCX
        const outputPath = await generateDocx(filesData, mermaidDiagrams);

        console.log('\n═══════════════════════════════════════');
        console.log('✅ DOCX 生成完成!');
