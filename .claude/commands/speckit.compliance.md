---
description: 從專案上下文產生法遵依據與系統對應文件（50_compliance.md），包含適用法規、法規需求對應、法遵控制點與證據留存要求。
---
...
1. **載入相關文件**：
   ...
   - `40_infosec.md`（資安法規）
   - 設定 COMPLIANCE_DIR = `$REPO_ROOT/specs/compliance`
...
- 避免重複，50_compliance.md 引用 40_infosec.md 的控制
...
📄 檔案路徑: specs/compliance/50_compliance.md
...
- **00_meta.md** 的監理要求 → **50_compliance.md** 的適用法規
- **30_risk_control.md** 的合規風險 → **50_compliance.md** 的法遵控制點
- **40_infosec.md** 的資安控制 → **50_compliance.md** 引用（避免重複）
- **60_audit.md** 的稽核需求 ← **50_compliance.md** 的證據留存要求
...
5. **避免重複**：資安法規要求已在 40_infosec.md，50_compliance.md 引用即可
