---
description: 審核 Bank Profile (00-70) 完整性與邏輯一致性,生成專案總結文件,為憲法建立準備輸入。
---
...
此命令用於**審核專案層級 Bank Profile 文件的完整性與邏輯一致性**,並產出專案總結文件。這是從 Bank Profile (00-70) 過渡到憲法建立與功能開發的關鍵步驟。

## 目標定位

**/speckit.review 關注**:
- **COMPLETENESS**: Bank Profile (00-70) 是否完整 (必要文件是否存在)
...
| 20_process.md | 必須 | 缺少流程設計基礎 |

**檢查建議文件** (P1 - 強烈建議):

| 檔案 | 建議性 | 若缺少的影響 |
|------|--------|------------|
| 30_risk_control.md | 強烈建議 | 缺少風險管理框架 |
| 40_infosec.md | 強烈建議 | 缺少資安需求定義 |
| 50_compliance.md | 建議 | 可能不符合法遵要求 |
| 60_audit.md | 建議 | 缺少稽核追蹤需求 |
| 70_nfr.md | 建議 | 缺少非功能需求定義 |
...
graph TD
    ...
    B --> C[20_process.md]
    C --> D[30_risk_control.md]
    D --> E[40_infosec.md]
    E --> F[50_compliance.md]
    F --> G[60_audit.md]
    D --> G
    E --> G
    F --> G
...
1. **00_meta.md → 其他文件**:
   ...
   - [ ] 監理要求在法遵文件中有對應 (50_compliance.md)

2. **10_business.md → 20_process.md**:
   - [ ] 使用者故事 (10) 對應到流程步驟 (20)
   - [ ] KPI (10) 有對應的流程效率指標 (20)

3. **20_process.md → 30_risk_control.md**:
   - [ ] 流程例外情境 (20) 對應到風險 (30)
   - [ ] 關鍵流程步驟有對應的控制措施 (30)

4. **30_risk_control.md → 40_infosec.md**:
   - [ ] 資安風險 (30) 有對應的資安控制 (40)
   - [ ] KRI 監控指標 (30) 有對應的監控機制 (40 日誌)

5. **40_infosec.md → 50_compliance.md**:
   - [ ] 資安控制 (40) 符合法遵要求 (50)
   - [ ] 資料分級 (40) 符合個資法要求 (50)

6. **50_compliance.md → 60_audit.md**:
...
⚠️ 需處理的警告 (3 項):
  ...
  - [W003] 60_audit.md 的日誌保留期限與 50_compliance.md 法規要求不一致
