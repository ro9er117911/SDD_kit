...
在 Antigravity 聊天介面（右側），您可以直接輸入檔名或目錄來引用上下文，並說明您的需求。
- **引用單一檔案**：輸入 `@filename.md`
- **引用資料夾**：輸入 `@foldername/`

**範例**：
> `@00_meta.md` 請幫我把專案負責人改為 "Alice"。

### Q2: Mermaid 流程圖顯示有問題怎麼處理？

如果預覽時圖表無法顯示或有語法錯誤，請直接請 AI 助手修復。

**範例**：
> 這裡的 Mermaid 語法好像有誤，請幫我修正讓它能正確顯示。

Antigravity 會分析錯誤並自動更正語法。
